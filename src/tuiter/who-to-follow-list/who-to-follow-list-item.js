    ...
    <li className="list-group-item ps-4 pe-4">
        <div className="row" style={{height: "50px"}}>
            <div className="col-2 ps-0 pe-0">
                <img className="center-block rounded-circle " alt="user profile" src={who.avatarIcon} height="50px" width="50px" style={{"objectFit": "cover"}}></img>
            </div>
            <div className="col-7 ps-3 pe-0">
